...
public class LMTPartnerInactivate extends SeleniumBase
{
	public static By btnBusinessEntity = By.xpath(".//*[@id='NavigationMenu']/ul/li[1]/a/span[2]/span");
	public static By btnPInactivate = By.xpath(".//*[@id='TreeScreent23']");
		...
		//int Row_count = driver.findElements(By.xpath(".//*[@id='ContentPlaceHolder1_dtgRoles']/tbody/tr")).size(); 
				...
				for (int i=2; i<=Row_count; i++)
				{
						...
						if(Table_data.equals(pCode)){
							...
							String xpath_for_PartnerInactive = editPart1+(i-2)+editPart2;
							...
							{	
								btnGrdInactive = By.xpath(xpath_for_PartnerInactive);
