...
public class LMTExchangeCompanyACCreateAuthorize extends SeleniumBase
{
	...
	String authorizePart1 = ".//*[@id='ContentPlaceHolder1_GridViewExHouseSearch_btnAuthorize_";
	...
	String authorize1Part1 = ".//*[@id='grdBEAccount_lbnEdit_";
	String authorize1Part2 = "']";
	...
	public static By grdBtnAuthorize;
	
	public static By btnApprove = By.xpath(".//*[@id='btnSave']");
		...
		//int Row_count = driver.findElements(By.xpath(".//*[@id='ContentPlaceHolder1_dtgRoles']/tbody/tr")).size(); 
				...
				for (int i=2; i<=Row_count; i++)
				{
						...
						if(Table_data.equals(businessEntityName)){
							...
							String xpath_for_authorizeButton = authorizePart1+(i-2)+authorizePart2;
							
							if(readAndCompare(grdBusinessEntityName, businessEntityName))
							{	
								btnAuthorize = By.xpath(xpath_for_authorizeButton);
								click(btnAuthorize);
							}											
							return;
						}	
		...
		//int Row_count = driver.findElements(By.xpath(".//*[@id='ContentPlaceHolder1_dtgRoles']/tbody/tr")).size(); 
				...
				for (int i=2; i<=Row_count1; i++)
				{
						...
						if(Table_data.equals(acNo)){
							...
							String xpath_for_authorizeButton = authorize1Part1+(i-2)+authorize1Part2;
							...
							{	
								grdBtnAuthorize = By.xpath(xpath_for_authorizeButton);
								click(grdBtnAuthorize);
							}											
							return;
						}	
					}
	...
	public void validateAuthorize(String message)
	{
		try
		{
			click(btnApprove);
