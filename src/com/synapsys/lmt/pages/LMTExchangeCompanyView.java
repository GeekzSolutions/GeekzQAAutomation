...
public class LMTExchangeCompanyView extends SeleniumBase
{
	//initial page
	public static By btnBusinessEntity = By.xpath(".//*[@id='NavigationMenu']/ul/li[1]/a/span[2]/span");
	public static By btnBEView = By.xpath(".//*[@id='TreeScreent8']");
	...
	public static By grdCode;
	public static By grdName;
	...
	//View Page
	public static By txtCompanyCode = By.xpath(".//*[@id='ContentPlaceHolder1_tabExHouse_generalTab_txtexcode']");
	public static By txtCompanyName = By.xpath(".//*[@id='ContentPlaceHolder1_tabExHouse_generalTab_txtexhousename']");
	...
	public static By txtAddLine2 = By.xpath(".//*[@id='ContentPlaceHolder1_tabExHouse_contactTab_txtaddress2']");
		...
		for (int i=2; i<=Row_count; i++){
			for(int j=1; j<=1; j++){
				...
				if(Table_data.equals(code)){
					...
					grdCode = By.xpath(xpath_for_BE_Code);
					...
					grdName =By.xpath(Xpath_for_Name);
					...
					if(readAndCompare(grdCreatedDate, date) && readAndCompare(grdName, name) && readAndCompare(grdCode, code) && readAndCompare(grdCountry, country) && readAndCompare(grdStatus, status))
					{	
	...
	public void Search_Grid_for_BE_Code(String date, String code, String name, String country, String status) throws InterruptedException
	{
		if(Row_count<10)
		{
	...
	public void validateCompanyInfo(String CompanyCode, String CompanyName, String CompanyCountry, String name, String designation, String contactNo, String Email, String workArea)
	{
		if (readAndCompareByValue(txtCompanyCode, CompanyCode) && readAndCompareByValue(txtCompanyName, CompanyName) &&readAndCompareByValue(cmbCountry, CompanyCountry))
		{
	...
	public void validateContactInfo(String addl1, String addl2, String city)
	{
		if(readAndCompareByValue(txtAddLine1, addl1) && readAndCompareByValue(txtAddLine2, addl2) && readAndCompareByValue(txtCity, city))
		{
			click(tabAdmiInfo);
		}
	}
