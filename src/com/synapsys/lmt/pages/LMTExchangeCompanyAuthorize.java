...
public class LMTExchangeCompanyAuthorize extends SeleniumBase 
{
	public static By btnBusinessEntity = By.xpath(".//*[@id='NavigationMenu']/ul/li[1]/a/span[2]/span");
	public static By btnAuthorize = By.xpath(".//*[@id='TreeScreent10']");
	public static By btnCompanyAuthorize;
		...
		//int Row_count = driver.findElements(By.xpath(".//*[@id='ContentPlaceHolder1_dtgRoles']/tbody/tr")).size(); 
				...
				for (int i=2; i<=Row_count; i++)
				{
						...
						if(Table_data.equals(ecCode)){
							...
							String xpath_for_ComapanyAuthorize = authorizePart1+(i-2)+authorizePart2;
							...
							{	
								btnCompanyAuthorize = By.xpath(xpath_for_ComapanyAuthorize);
								click(btnCompanyAuthorize);
							}											
							return;
						}	
					}
