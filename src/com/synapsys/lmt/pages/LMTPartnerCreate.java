...
public class LMTPartnerCreate extends SeleniumBase
{
	public static By btnBusinessEntity = By.xpath(".//*[@id='NavigationMenu']/ul/li[1]/a/span[2]/span");
	public static By btnPartnerCreate = By.xpath(".//*[@id='TreeScreent20']");
	
	public static By cmbPBankName = By.xpath(".//*[@id='ContentPlaceHolder1_tabExHouse_generalTab_ddlBank']");
	...
	public void clickBasic()
	{
		...
		click(btnPartnerCreate);
	}
	
	public void generalInfo(String PBankName, String Country, String DVBBranch,  String CPName, String ContactNo, String WorkArea, String Designation, String Email)throws Exception
	{
		select(cmbPBankName, PBankName);
		select(cmbCountry, Country);
		select(cmbRelatedDVBBranch, DVBBranch);
	...
	public void contactDetails(String addl1, String street, String city, String contactNo, String contactType)throws Exception
	{
		clearAndType(txtAddressl1, addl1);
		clearAndType(txtstreet, street);
