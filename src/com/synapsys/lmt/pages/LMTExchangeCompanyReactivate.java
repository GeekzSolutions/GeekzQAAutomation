...
public class LMTExchangeCompanyReactivate extends SeleniumBase
{
	public static By btnBusinessEntity = By.xpath(".//*[@id='NavigationMenu']/ul/li[1]/a/span[2]/span");
	public static By btnECReactivate = By.xpath(".//*[@id='TreeScreent13']");
		...
		//int Row_count = driver.findElements(By.xpath(".//*[@id='ContentPlaceHolder1_dtgRoles']/tbody/tr")).size(); 
				...
				for (int i=2; i<=Row_count; i++)
				{
						...
						if(Table_data.equals(ecCode)){
							...
							String xpath_for_ComapanyReactive = editPart1+(i-2)+editPart2;
							...
							{	
								btnGrdReactive = By.xpath(xpath_for_ComapanyReactive);
