...
public class LMTExchangeCompanyACReactivate extends SeleniumBase
{
	...
	public static By btnReactivate;
	...
	String reactivatePart1 = ".//*[@id='ContentPlaceHolder1_GridViewExHouseSearch_btnReActivate_";
	String reactivatePart2 = "']";
	
	String table1Part1 = ".//*[@id='grdBEAccount']/tbody/tr[";
	String table1Part2 = "]/td[";
	String table1Part3 = "]";
	
	String reactivate1Part1 = ".//*[@id='grdBEAccount_lbnEdit_";
	String reactivate1Part2 = "']";
	...
	public static By grdBtnReactive;
		...
		//int Row_count = driver.findElements(By.xpath(".//*[@id='ContentPlaceHolder1_dtgRoles']/tbody/tr")).size(); 
				...
				for (int i=2; i<=Row_count; i++)
				{
						...
						if(Table_data.equals(businessEntityName)){
							...
							String xpath_for_authorizeButton = reactivatePart1+(i-2)+reactivatePart2;
							
							if(readAndCompare(grdBusinessEntityName, businessEntityName))
							{	
								btnReactivate = By.xpath(xpath_for_authorizeButton);
								click(btnReactivate);
							}											
							return;
						}	
		...
		//int Row_count = driver.findElements(By.xpath(".//*[@id='ContentPlaceHolder1_dtgRoles']/tbody/tr")).size(); 
				...
				for (int i=2; i<=Row_count1; i++)
				{
						...
						if(Table_data.equals(acNo)){
							...
							String xpath_for_authorizeButton = reactivate1Part1+(i-2)+reactivate1Part2;
							...
							{	
								grdBtnReactive = By.xpath(xpath_for_authorizeButton);
								click(grdBtnReactive);
							}											
							return;
						}	
					}
